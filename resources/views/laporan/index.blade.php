...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
    ...
    <div class="card">
        <div class="card-body" style="text-align: center;">
            <div style="font-size: 64px; margin-bottom: 20px; color: #27ae60;">
    ...
    <div class="card">
        <div class="card-body" style="text-align: center;">
            <div style="font-size: 64px; margin-bottom: 20px; color: #e74c3c;">
...
<div class="card" style="margin-top: 30px;">
    <div class="card-body">
        <h3 style="margin-bottom: 15px;">
            <i class="fas fa-info-circle"></i> Panduan Generate Laporan
        </h3>
