    ...
    <div class="card-body">
        <form action="{{ route('spp.update', $spp->id_spp) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="tahun" id="tahun" class="form-control @error('tahun') is-invalid @enderror" value="{{ old('tahun', $spp->tahun) }}" placeholder="Contoh: 2025" min="2020" max="2100" required>
                @error('tahun')
            ...
            <div class="form-group">
                ...
                <input type="number" name="nominal" id="nominal" class="form-control @error('nominal') is-invalid @enderror" value="{{ old('nominal', $spp->nominal) }}" placeholder="Contoh: 175000" min="0" required>
                @error('nominal')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
